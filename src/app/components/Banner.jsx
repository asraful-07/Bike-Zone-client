            ...
            <div className="flex items-center justify-between gap-10 px-10 py-12">
              ...
              <div className="flex-1">
                <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4 leading-tight">
                  Power Your <span className="text-orange-600">Passion</span>{" "}
                  with CoursePilot
                </h2>
                <p className="text-base md:text-lg text-gray-700 mb-6 leading-relaxed">
                  Discover high-quality courses, expert instructors, and the
                  tools you need to thrive in today's fast-paced world. It's
                  time to take charge of your future with the right knowledge.
                </p>
            ...
            <div className="flex items-center justify-between gap-10 px-10 py-12">
              ...
              <div className="flex-1">
                ...
                <p className="text-base md:text-lg text-gray-700 mb-6 max-w-xl leading-relaxed">
                  ...
                  projects, expert guidance, and a strong learning community.
